"""Chatterbox Turbo ストリーミング生成テスト（Voice Cloning あり）。

参照音声を使った Voice Cloning でストリーミング生成を行い、
...
# ★ 自分の参照音声ファイルのパスに書き換えてください
AUDIO_PROMPT_PATH = "assets/ref_24k_mono.wav"
...
# ---- ストリーミング生成 (Voice Cloning あり) ----
print(f"\n{'='*60}")
print("[TEST] Streaming WITH voice cloning")
print(f"  audio_prompt: {AUDIO_PROMPT_PATH}")
print(f"{'='*60}")
...
if not chunks:
    ...
    output_path = "test-turbo-stream-cloned.wav"
